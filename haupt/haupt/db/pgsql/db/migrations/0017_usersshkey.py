# Generated by Django 5.2.14 on 2026-05-20 16:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, max_length=128, validators=[django.core.validators.RegexValidator(re.compile('^[-a-zA-Z0-9_]+\\Z'), 'Enter a valid “slug” consisting of letters, numbers, underscores or hyphens.', 'invalid'), haupt.common.validation.blacklist.validate_blacklist_name])),
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['name'], name='db_usersshk_name_55873d_idx')],
            },
        ),
    ]
