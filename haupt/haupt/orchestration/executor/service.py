...
class ExecutorService(EventService):
    HANDLER_MAPPING = {
        run.RUN_CREATED: RunsHandler.handle_run_created,
        run.RUN_RESUMED_ACTOR: RunsHandler.handle_run_created,
        run.RUN_APPROVED_ACTOR: RunsHandler.handle_run_approved_triggered,
        run.RUN_STOPPED_ACTOR: RunsHandler.handle_run_stopped_triggered,
        run.RUN_NEW_ARTIFACTS: RunsHandler.handle_new_artifacts,
        run.RUN_DELETED_ACTOR: RunsHandler.handle_run_deleted,
    }
